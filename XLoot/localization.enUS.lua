...
L:RegisterTranslations("enUS", function()
	return {
		...
		["2.0 compatability"] = true,
		["If you're getting errors with table.setn, enable this"] = true,
		...
		descCollapse = "Collapse looted (empty) buttons and place cursor over next frame if the Snap option is enabled.",
