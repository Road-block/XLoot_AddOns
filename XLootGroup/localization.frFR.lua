...
L:RegisterTranslations("frFR", function()
	return {
		...
		["Roll button size"] = "Taille des bouttons de lancer",
		["Size of the Need, Greed, and Pass buttons"] = "Taille des bouttons de Besoin, Cupidité et Passe",
		["XLoot Group"] = "XLoot Group",
		["A stack of frames for showing group loot information"] = "Un ensemble d'affichage pour les loots de groupe",
